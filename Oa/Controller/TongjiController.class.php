...
//		$objPHPExcel = new \Think\PHPExcel();
	...
	public function report_qudao()
	{
		...
		if ($canshu['submit1'] != '') {
			...
			*/
			if($canshu['yy_ID'] == ''){
				$sql = 'select ID,xx_name,yy_ID from oa_xinxilaiyuan';
			}else{
...
//		$objPHPExcel = new \Think\PHPExcel();
	...
	public function report_zixunyuan()
	{
		...
		*/
		...
		if($canshu['yy_ID'] == ''){
			$sql = 'select user_ID,username,userchinaname,QQhaoma from oa_useradmin where user_del=0 and role_ID in(4,5)';
		}else{
