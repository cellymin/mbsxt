...
class GetWordRequest
{
  ...
  public $wordFields;    //指定需要返回的关键词属性 请参考表keywordfields (关键词ID，推广计划ID， )
  public $ids; //查询ID集合 idtype 类型为5（单元） 不超过50个，idtype类型为11（关键词）不超过10000个
  public $idType;   // 5是单元ID， 11是关键词 ID
  public $getTemp; // 是否查询关键词影子 
...
class KeywordType
{
  ...
  public $campaignId;  //推广计划ID
  public $keywordId;  // 关键词ID
  public $adgroupId;  //推广单元ID
  public $keyword;  //关键词字面 40字节长 一个中文字符占2个
  public $price;  //关键词 竞价价格   出价
  public $destinationUrl; // 访问URL
  public $matchType; //匹配模式
  public $pause; // 暂停启用关键词
  public $status;  // 关键词状态
  public $pcDestinationUrl;// PC访问URL
  public $mobileDestinationUrl; //移动访问URL
  public $phraseType;  // 短语细分匹配模式
  public $wmatchprefer; //是否接受单元的分匹配出价比例
  public $deviceprefer;  //
  public $owmatch;
  public $pcQuality; // PC端该关键词的质量度 1-10分
  public $pcReliable; //PC 端是否为临时质量度
  public $pcReason; // 质量度原因
  public $pcScale;  // PC竞争关系分布
  public $mobileQuality; // 移动端该关键词的质量度 1-10分
  public $mobileReliable;//移动 端是否为临时质量度
  public $mobileReason;// 质量度原因
  public $mobileScale;// 移动竞争关系分布
  public $temp;
  public $operator;
