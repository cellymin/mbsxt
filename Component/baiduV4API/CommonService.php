...
//USERNAME
define ( 'USERNAME', '尚美妇科医院' );//8425kmqsyy  尚美妇科医院

//PASSWORD
define ( 'PASSWORD', 'HNCShszfyyy@963.' ); //KMQSYYxh0871  HNCShszfyyy@963.

//TOKEN
define ( 'TOKEN', 'ff879010c3cc7829d24b024eaeb550bc' ); //0e7029ef930080915218f004c6dc7567  ff879010c3cc7829d24b024eaeb550bc

//TARGET 52845b9e69da25aff68816c904ebc5df
define ( 'TARGET', '' );
...
class CommonService {
	...
	public function executeJson($method, $request) {
		...
		curl_close ($ch );
		//echo /*"json string: " .*/ $this->json_string;
