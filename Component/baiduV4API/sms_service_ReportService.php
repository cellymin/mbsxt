...
class GetProfessionalReportIdRequest   // 获取接口报告请求
{
...
class GetRealTimeDataRequest //（实时报告请求-包含多类报告）
{
...
class GetRealTimeQueryDataRequest //搜索词报告请求 
{
...
{    public function __construct() {  
 ...
 public function getRealTimeQueryData ($getRealTimeQueryDataRequest){ //（搜索词报告)
 return $this->execute ( 'getRealTimeQueryData', $getRealTimeQueryDataRequest );
}
 public function getRealTimePairData ($getRealTimePairDataRequest){ //（配对报告）
 return $this->execute ( 'getRealTimePairData', $getRealTimePairDataRequest );
}
 public function getReportState ($getReportStateRequest){ //（异步报告）
 return $this->execute ( 'getReportState', $getReportStateRequest );
}
 public function getReportFileUrl ($getReportFileUrlRequest){ //（异步报告）
 return $this->execute ( 'getReportFileUrl', $getReportFileUrlRequest );
}
 public function getRealTimeData ($getRealTimeDataRequest){ //（实时报告-包含多类报告）
 return $this->execute ( 'getRealTimeData', $getRealTimeDataRequest );
}
 public function getProfessionalReportId ($getProfessionalReportIdRequest){ //（异步报告）
