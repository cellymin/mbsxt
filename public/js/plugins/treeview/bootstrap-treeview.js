	...
	Tree.prototype = {
		...
		_buildTree: function(nodes, level) {
			...
			$.each(nodes, function addNodes(id, node) {
				...
				if (self.options.showhh && node.hh) {
					$.each(node.hh, function addh(id, hh) {
						treeItem
							.append($(self._template.badge)
								.append(hh)
							);
				...
				if (self.options.showgg && node.gg) {
					$.each(node.gg, function addg(id, gg) {
						treeItem
							.append($(self._template.badge)
								.append(gg)
							);
				...
				if (self.options.showff && node.ff) {
					$.each(node.ff, function addf(id, ff) {
						treeItem
							.append($(self._template.badge)
								.append(ff)
							);
				...
				if (self.options.showee && node.ee) {
					$.each(node.ee, function adde(id, ee) {
						treeItem
							.append($(self._template.badge)
								.append(ee)
							);
				...
				if (self.options.showdd && node.dd) {
					$.each(node.dd, function addd(id, dd) {
						treeItem
							.append($(self._template.badge)
								.append(dd)
							);
				...
				if (self.options.showcc && node.cc) {
					$.each(node.cc, function addc(id, cc) {
						treeItem
							.append($(self._template.badge)
								.append(cc)
							);
				...
				if (self.options.showbb && node.bb) {
					$.each(node.bb, function addb(id, bb) {
						treeItem
							.append($(self._template.badge)
								.append(bb)
							);
				...
				if (self.options.showaa && node.aa) {
					$.each(node.aa, function adda(id, aa) {
						treeItem
							.append($(self._template.badge)
								.append(aa)
							);
